...
// User routes
router.route('/invoice/generate/:orderId').post(isAuthenticatedUser, generateInvoice);
...
// Admin routes
router.route('/admin/invoices').get(isAuthenticatedUser, authorizeRoles('admin'), getAllInvoices);
router.route('/admin/invoice/:id')
